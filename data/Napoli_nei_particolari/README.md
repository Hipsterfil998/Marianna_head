This folder contains the data extracted from the webiste "Napoli nei particolari" for sections "history", "places" and "legends"

## 1. napoli_particolari_luoghi.tsv
...
## 2. napoli_particolari_storia.tsv
...
## 3. napoli_particolari_leggende.tsv
